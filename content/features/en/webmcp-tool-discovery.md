---
title: WebMCP tool discovery
description: "Expose the active page tool list and schemas to a WebMCP-aware agent. Draft and implementation support are tracked independently."
slug: webmcp-tool-discovery
locale: en
seoTitle: "WebMCP tool discovery compatibility — Can My Agent Use"
socialTitle: WebMCP tool discovery
socialDescription: "Expose the active page tool list and schemas to a WebMCP-aware agent. Browser and agent evidence remains revision-specific."
llmSummary: "WebMCP tool discovery is an atomic WebMCP capability and does not imply every other part of the draft."
...
category: interfaces
summary: "Expose the active page tool list and schemas to a WebMCP-aware agent."
