...
notes:
  - id: 83
    text: "Evidence checked 2026-08-29: exhaustive stable-source review establishes that Aider v0.86.0 does not implement notifications/prompts/list_changed or prompt-list refresh."
  - id: 76
    ...
    versions:
      - track: current
        ...
        qualifiers:
          ...
          - type: host-role
            value: "no MCP prompt-list notification handler"
        evidence:
