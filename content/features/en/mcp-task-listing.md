...
notes:
  - id: 83
    text: "Evidence checked 2026-08-29: exhaustive stable-source review establishes that Aider v0.86.0 does not implement MCP tasks/list, cursor pagination, or task retrieval."
  - id: 76
      ...
      - track: current
        ...
        qualifiers:
          ...
          - type: protocol-revision
            value: "no MCP task-listing utility"
        evidence:
