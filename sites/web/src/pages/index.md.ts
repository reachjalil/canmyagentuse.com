  ...
  return markdownResponse(
    toEntryMarkdown({
      ...
      body: [
        ...
        "",
        "Find apps your agent can actually use. Know what works, see what needs you, and pick your next app.",
        "",
        "- [Submit your app](/submit-app.md) — free submission for independent editorial review",
        "",
