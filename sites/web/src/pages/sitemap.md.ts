...
export const GET: APIRoute = async () => {
  ...
  const sections = [
    ...
    "- [Provider mark provenance](/provider-marks.md) — pinned source and review metadata for secondary reference marks",
    ...
    "- [Provider mark provenance](/provider-marks.md) — source, license, review date, and non-affiliation boundary",
    "",
    "## News",
    "",
    ...items(
